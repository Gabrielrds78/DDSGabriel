...
/*
Seu tio tem uma corretora de seguros e precisa de um sistema para calcular o valores de apólices para facilitar
o processo de venda de seguros.

No momento, a corretora trabalha apenas com seguros de carros e imóveis,
mas em breve serão adicionados outros tipos de contratos de seguros.

Essa informação é muito importante, pois o software deve ter a capacidade de receber novos tipos de seguros facilmente,
como por exemplo, notebook, barcos, aeronaves, etc.
...
3. Se Carro diz que implementa a interface Seguravel, ela deve implementar todos os métodos especificados na interface,
pois uma interface é um contrato, ou seja, a classe deve garantir que faz o que ela pede.
...
No método main(), instanciamos uma corretora de seguros, um carro e um imóvel,
depois chamamos o método fazerPropostaSeguro() da corretora passando como parâmetro o carro e depois o imóvel.

8. Compile tudo e execute a classe Principal.

9. Quando tudo estiver funcionando, crie uma classe chamada Barco e outra chamada Notebook.
As duas classes devem implementar a interface Seguravel.
